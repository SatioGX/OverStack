...
export default function Question() {
  return (
    <div className="grid p-0">
        <div className="col-1 flex flex-column p-2 gap-4 align-items-start">
            <h6 className="text-sm m-0">0 votes</h6>
            <h6 className="text-sm m-0">0 answers</h6>
        </div>
        <div className="col-11 flex flex-column p-2 gap-4 align-items-start ">
        ...
        <div className="col-11 grid px-2 py-0 m-0">
            ...
            <div className="col-4 flex py-0 m-0 gap-2 justify-content-end">
